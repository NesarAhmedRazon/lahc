...
function lahc_settings_style() {
    wp_enqueue_style('lahc_settings-styles', get_template_directory_uri().'/css/admin_style.css');
...
<h1>LAHC Settings</h1>
    ...
    <div>
        <div>
            ...
            <textarea name="gglan" id="" class=" lahcTextarea regular-text code" cols="30" rows="10"><?php echo esc_attr( get_option('gglan') ); ?></textarea>
        </div>
    </div>
    </form>
</div>
